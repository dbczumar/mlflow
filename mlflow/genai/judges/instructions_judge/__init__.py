...
class InstructionsJudge(Judge):
    ...
    def _build_user_message(
        ...
        template_values = self._build_template_values(trace_id, inputs, outputs, expectations, conversation)
        field_vars = [var for var in self._ordered_template_variables]
    ...
    def _evaluate_impl(
        ...
        *,
        ...
        user_content = self._build_user_message(trace.info.trace_id, inputs, outputs, expectations, conversation)
