        ...
        *,
        ...
        if trace is not None:
            ...
            augmented_prompt = (
                ...
                "1. ALWAYS fetch the trace metadata to understand the overall context, "
                "timing, and execution details\n"
                "2. ALWAYS retrieve the root span to understand the top-level inputs and outputs "
                "of the interaction\n"
                "3. ALWAYS list all spans to see the complete trace structure and understand "
