        ...
        *,
        ...
        if trace is not None:
            ...
            augmented_prompt = (
                ...
                "1. ALWAYS start by calling 'get_trace_info' to understand the overall trace "
                "context and timing\n"
                "2. ALWAYS call 'get_root_span' to understand the top-level inputs and outputs\n"
                "3. ALWAYS call 'list_spans' to see all spans and understand the trace structure\n"
                "4. After completing steps 1-3, use additional tools as needed:\n"
