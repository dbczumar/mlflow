...
_GETCREDENTIALSFORREAD_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='credentials_batch', full_name='mlflow.GetCredentialsForRead.Response.credentials_batch', index=0,
...
_GETCREDENTIALSFORWRITE_RESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='credentials_batch', full_name='mlflow.GetCredentialsForWrite.Response.credentials_batch', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETCREDENTIALSFORREAD_RESPONSE.fields_by_name['credentials_batch'].message_type = _ARTIFACTCREDENTIALINFO
_GETCREDENTIALSFORREAD_RESPONSE.containing_type = _GETCREDENTIALSFORREAD
_GETCREDENTIALSFORWRITE_RESPONSE.fields_by_name['credentials_batch'].message_type = _ARTIFACTCREDENTIALINFO
