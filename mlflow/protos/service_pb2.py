...
_MLFLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\362\206\031_\n#\n\003PUT\022\026/mlflow/runs/log-model\032\004\010\002\020\000\n+\n\003PUT\022\036/preview/mlflow/runs/log-model\032\004\010\002\020\000\020\001*\tLog Model'),
  ),
])
