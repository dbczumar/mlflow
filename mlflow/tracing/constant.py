...
class AssessmentMetadataKey:
    ...
    # When an Issue assessment is generated by the trace insights analysis job, log the job ID here.
    ISSUE_ANALYSIS_JOB_ID = "mlflow.assessment.issueAnalysisJobId"
