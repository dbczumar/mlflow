...
MLflow Evaluation Datasets are useful when you need to convert traces to evaluation records.
...
To create datasets from traces or scratch, see [Build evaluation datasets](/genai/datasets/).
...
eval_data = [
    ...
    },
    {
        ...
        "expectations": {"expected_facts": ["observability", "evaluation", "prompt management", "AI Gateway"]},
    },
]
...
For production, convert to an [MLflow Evaluation Dataset](/genai/datasets/).
