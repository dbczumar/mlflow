...
KNOWLEDGE_BASE = {
    "mlflow": [
        Document(
            id="doc_1",
            page_content="MLflow is the largest open source AI engineering platform for agents and LLMs. It enables teams to build production-quality agents and ML models.",
...
eval_dataset = [
    {
        ...
        "expectations": {
            "expected_facts": [
                "MLflow is the largest open source AI engineering platform",
