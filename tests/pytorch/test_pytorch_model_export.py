...
def test_pyfunc_model_serving_with_subclassed_nn_model_and_default_conda_env(
    ...
    # import cloudpickle
    # with open("/tmp/item.pkl", "wb") as f:
    #     import pickle
    #     pickler = cloudpickle.CloudPickler(f)
    #     pickler.dump(subclassed_model)
    # return
    mlflow.pytorch.save_model(path=model_path, pytorch_model=subclassed_model, conda_env=None, pickle_module=mlflow.pytorch)
